    ...
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-12 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-neutral-200 dark:border-neutral-800">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mt-1 text-sm text-neutral-600 dark:text-neutral-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border-0 shadow-2xl rounded-2xl overflow-hidden">
          <CardHeader className="pb-2 border-b border-neutral-200 dark:border-neutral-800">
          ...
          <CardContent className="pt-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-white/50 dark:bg-black/50 backdrop-blur-sm border-neutral-200 dark:border-neutral-800 focus:ring-2 focus:ring-neutral-500 transition-all"
            ...
            <div className="flex justify-end pt-2">
              <Button
                ...
                disabled={isSavingProfile}
                className="bg-gradient-to-r from-neutral-800 to-black hover:from-neutral-900 hover:to-neutral-900 text-white shadow-lg shadow-neutral-200 dark:shadow-black/50 transition-all"
              >
                {isSavingProfile ? (
        ...
        <div className="space-y-6">
          <Card className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border-0 shadow-2xl rounded-2xl">
            <CardHeader className="pb-2 border-b border-neutral-200 dark:border-neutral-800">
            ...
            <CardContent className="pt-4 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-neutral-900 dark:text-white">{profile.username}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-neutral-900 dark:text-white">{roleConf.label}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
                  <CalendarDays className="h-5 w-5 text-neutral-600 dark:text-neutral-400" />
                </div>
                <div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-400">Terdaftar</p>
          ...
          <Card className="bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border-amber-200 dark:border-amber-900/50 shadow-2xl rounded-2xl overflow-hidden">
            ...
            <CardContent className="pt-4 space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pr-10 bg-white/50 dark:bg-black/50 backdrop-blur-sm border-neutral-200 dark:border-neutral-800"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/50 dark:bg-black/50 backdrop-blur-sm border-neutral-200 dark:border-neutral-800"
                  disabled={isSavingPassword}
                />
              </div>
